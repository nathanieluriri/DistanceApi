...
for payment in successful_payments:
    if payment['status'] == 'succeeded':
       ...
       for doc in documents:  
          if  (doc['pick_up_details']['mainText'] in payment['itemsBought'][0]['productDescription']) and (doc['drop_off_details']['mainText']in payment['itemsBought'][0]['productDescription']):
